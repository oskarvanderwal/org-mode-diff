...
OrgTree = collections.namedtuple(
    "OrgTree",
    [
...
OrgHeading = collections.namedtuple(
    "OrgHeading",
    [
        "star_count",  # int
        "title",  # string
...
DiffTuple = collections.namedtuple(
    "DiffTuple",
    [
        "old",
        "new",
...
def getattrs_from_diff(diff_tuple, property, default=None):
    return DiffTuple(
        getattr(diff_tuple.old, property, default),
        getattr(diff_tuple.new, property, default),
    )
